		...
		<div class="container-fluid tt-top-line">
			<div class="row">
				<div class="tt-logo-container">
					<!-- mobile logo -->
					<a class="tt-logo tt-logo-alignment" href="index.html"><img src="{{ asset('/') }}images/custom/logo.png" alt=""></a>
					<!-- /mobile logo -->
				</div>
			</div>
		</div>
												...
												<div class="col">
													...
													<ul class="tt-megamenu-submenu">
														<li><a href="index.html">Home — Example 1
															<img src="{{ asset('/') }}images/loader.svg" data-src="images/custom/tt-layout-img-01.png" alt="Example 1">
												...
												<div class="col">
													...
													<ul class="tt-megamenu-submenu">
														<li><a href="index-skin-snowboards.html">Snowboards Shop
															<img src="{{ asset('/') }}images/loader.svg" data-src="images/custom/tt-skins-img-01.png" alt="Snowboards Shop">
															<span class="tt-badge tt-fatured">Popular</span>
														</a></li>
													...
													<div class="row tt-col-list">
														...
														<div class="col-sm-3">
															...
															<ul class="tt-listing-01">
																<li><a href="#" target="_blank"><img src="{{ asset('/') }}images/loader.svg" data-src="images/custom/brand-img-01.png" alt=""></a></li>
																<li><a href="#" target="_blank"><img src="{{ asset('/') }}images/loader.svg" data-src="images/custom/brand-img-02.png" alt=""></a></li>
																<li><a href="#" target="_blank"><img src="{{ asset('/') }}images/loader.svg" data-src="images/custom/brand-img-03.png" alt=""></a></li>
																<li><a href="#" target="_blank"><img src="{{ asset('/') }}images/loader.svg" data-src="images/custom/brand-img-04.png" alt=""></a></li>
																<li><a href="#" target="_blank"><img src="{{ asset('/') }}images/loader.svg" data-src="images/custom/brand-img-05.png" alt=""></a></li>
																<li><a href="#" target="_blank"><img src="{{ asset('/') }}images/loader.svg" data-src="images/custom/brand-img-06.png" alt=""></a></li>
															</ul>
														</div>
													</div>
												</div>
													...
													<div class="tt-menu-slider header-menu-product arrow-location-03 row">
															...
															<div class="tt-product thumbprod-center">
																<a href="product.html">
																	<div class="tt-image-box">
																		<span class="tt-img"><img src="{{ asset('/') }}images/product/product-01.jpg" alt=""></span>
																		<span class="tt-img-roll-over"><img src="{{ asset('/') }}images/product/product-01-02.jpg" alt=""></span>
																	</div>
														...
														<div class="col-2">
															<div class="tt-product thumbprod-center">
																<a href="product.html">
																	<div class="tt-image-box">
																		<span class="tt-img"><img src="{{ asset('/') }}images/product/product-02.jpg" alt=""></span>
																		<span class="tt-img-roll-over"><img src="{{ asset('/') }}images/product/product-02-02.jpg" alt=""></span>
																	</div>
																	<div class="tt-description">
																		<h2 class="tt-title">Flared Shift Dress</h2>
																		<div class="tt-price">
														...
														<div class="col-2">
															<div class="tt-product thumbprod-center">
																<a href="product.html">
																	<div class="tt-image-box">
																		<span class="tt-img"><img src="{{ asset('/') }}images/product/product-04.jpg" alt=""></span>
																		<span class="tt-img-roll-over"><img src="{{ asset('/') }}images/product/product-04-01.jpg" alt=""></span>
																	</div>
																	<div class="tt-description">
																		<h2 class="tt-title">Flared Shift Dress</h2>
																		<div class="tt-price">
														...
														<div class="col-2">
															<div class="tt-product thumbprod-center">
																<a href="product.html">
																	<div class="tt-image-box">
																		<span class="tt-img"><img src="{{ asset('/') }}images/product/product-05.jpg" alt=""></span>
																		<span class="tt-img-roll-over"><img src="{{ asset('/') }}images/product/product-05-02.jpg" alt=""></span>
																	</div>
																	<div class="tt-description">
																		<h2 class="tt-title">Flared Shift Dress</h2>
																		<div class="tt-price">
