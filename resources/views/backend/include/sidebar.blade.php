<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
      ...
      <!-- Layouts -->
      <li class="menu-item {{ Request::is('admin/ecommerce*') ? 'open active' : '' }}">
        ...
        <ul class="menu-sub">
          <li class="menu-item {{ Request::is('admin/ecommerce/categories*') ? 'active' : '' }}">
            <a href="{{ route('admin.categories.index') }}" class="menu-link">
              <div data-i18n="Without menu">Category</div>
            </a>
          </li>

          <li class="menu-item {{ Request::is('admin/ecommerce/products*') ? 'active' : '' }}">
      ...
      <li class="menu-item {{ Request::is('admin/setting*') ? 'open active' : '' }}">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class="menu-icon tf-icons bx bx-layout"></i>
        ...
        <ul class="menu-sub">
          <li class="menu-item {{ Request::is('admin/setting/general*') ? 'active' : '' }}">
            <a href="{{ route('admin.setting.general.index') }}" class="menu-link">
              <div data-i18n="Without menu">General</div>
            </a>
          </li>

          <li class="menu-item {{ Request::is('admin/setting/mail*') ? 'active' : '' }}">
            <a href="#" class="menu-link">
              <div data-i18n="Without menu">Mail</div>
            </a>
          </li>
        </ul>
      </li>
